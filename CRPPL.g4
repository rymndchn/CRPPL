...
//PARSER RULES.
generalquery: GET (OPERATING_FUNCTION OF)? IDENTIFIER (SEPARATOR (OPERATOR OF)? IDENTIFIER)* (FOR IDENTIFIER OPERATOR (LITERAL|IDENTIFIER) (SEPARATOR IDENTIFIER OPERATOR (LITERAL|IDENTIFIER))*)? ON IDENTIFIER (GROUPBY IDENTIFIER (SEPARATOR IDENTIFIER)*)*;
