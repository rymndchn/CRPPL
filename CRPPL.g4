...
//PARSER RULES.
generalquery: GET (OPERATING_FUNCTION OF)? LITERAL (COMMA GET (OPERATOR OF)? LITERAL)* (FOR LITERAL OPERATOR LITERAL (COMMA LITERAL OPERATOR LITERAL)*)?;
importfile: RESERVEDWORD RESERVEDWORD SEPARATOR LITERAL SEPARATOR LITERAL SEPARATOR;
altercolumn: (NEWCOLUMN|ALTERCOLUMN|DELETECOLUMN) LITERAL FOR LITERAL;
...
RESERVEDWORD: (CONSTANT | CREATEFUNCTION | ENDFUNCTION | RETURN | DO | TRUE | FALSE | IMPORTFILE | IS | XAXIS | YAXIS | LABEL | VALUE);
