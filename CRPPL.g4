...
//PARSER RULES.
generalquery: GET (OPERATING_FUNCTION OF)? (LITERAL|IDENTIFIER) (COMMA GET (OPERATOR OF)? (LITERAL|IDENTIFIER))* (FOR (LITERAL|IDENTIFIER) OPERATOR (LITERAL|IDENTIFIER) (COMMA (LITERAL|IDENTIFIER) OPERATOR (LITERAL|IDENTIFIER))*)?;
