...
booleanstatement: (
  OPENPARENTHESIS (NEGATOR)*(IDENTIFIER|TRUE|FALSE|NUM_EXPR) CLOSEPARENTHESIS | 
  
  OPENPARENTHESIS (NEGATOR)*(LITERAL|IDENTIFIER|TRUE|FALSE|NUM_EXPR| booleanstatement) ((OPERATOR|BOOLEAN_CONNECTOR (NEGATOR)*) (LITERAL|IDENTIFIER|TRUE|FALSE|NUM_EXPR|booleanstatement))* CLOSEPARENTHESIS 
);
